...
mock:
	mockgen -package mockdb --build_flags=--mod=mod -destination db/mock/store.go github.com/sheggsmann/simplebank/db/sqlc Store  

.PHONY: postgres createdb migrateup migratedown migrateup1 migratedown1 sqlc test server mock